...
def create_sprite_groups() -> None:
    ...
    CONTROLS["obj_mgr"].add_new_sprite_group("mm_interface_cursor", Group())
    ...
    CONTROLS["obj_mgr"].add_new_sprite_group("gm_finish", Group())
    CONTROLS["obj_mgr"].add_new_sprite_group("gm_hero", Group())
    ...
    CONTROLS["obj_mgr"].add_new_sprite_group("sc_bg", Group())
    return None
